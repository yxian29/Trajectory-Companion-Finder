                ...
                Tuple2<Integer, Cluster>, Tuple2<Integer, Cluster>>
{
    ...
    private List<Tuple2<Integer, DBSCANCluster>> _broadcastClusters;

    public ClusterJoinMapper(
            List<Tuple2<Integer, DBSCANCluster>> broadcastClusters,
    ...
    apply(Tuple2<Integer, DBSCANCluster> input) {
        ...
        for (Tuple2<Integer, DBSCANCluster> t: _broadcastClusters) {
